(function (window){
    requirejs([
        ...
        BB.view_definitions.footer = Backbone.View.extend({
            el: '#footer',
        ...
        BB.view_definitions.coming_soon = Backbone.View.extend({
            id: 'coming-soon',
        ...
        BB.view_definitions.loading = Backbone.View.extend({
            el: '#content',
        ...
        BB.view_definitions.alert = Backbone.View.extend({
            events: {
                '.close': 'hide_alert'
            },
        ...
        BB.view_definitions.modal = Backbone.View.extend({
            events: {
